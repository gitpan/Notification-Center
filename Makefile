...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Notification/Center.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Notification
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Notification
...
TO_INST_PM = lib/.DS_Store \
	lib/Notification/Center.pm

PM_TO_BLIB = lib/.DS_Store \
	blib/lib/.DS_Store \
	lib/Notification/Center.pm \
	blib/lib/Notification/Center.pm
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Notification/Center.pm $(INST_MAN3DIR)/Notification::Center.$(MAN3EXT) 
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  ...
	  lib/Notification/Center.pm blib/lib/Notification/Center.pm 
